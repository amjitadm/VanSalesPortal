...
function Dashboard({ entries, expenses, customers, stockMovements }) {
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto space-y-8 px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 slide-in-up">
          ...
          {/* Today's Sales */}
          <div className="metric-card bg-gradient-to-br from-green-500 to-green-600 text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all">
            ...
            <div>
              <p className="text-xs text-white opacity-90 mb-1">Today's Sales</p>
              <p className="text-2xl font-bold text-white">QAR {todaysSales.toLocaleString()}</p>
            </div>
          </div>

          {/* Today's Expenses */}
          <div className="metric-card bg-gradient-to-br from-red-500 to-red-600 text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-white bg-opacity-20 rounded-xl">
            ...
            <div>
              <p className="text-xs text-white opacity-90 mb-1">Today's Expenses</p>
              <p className="text-2xl font-bold text-white">QAR {todaysExpenses.toLocaleString()}</p>
            </div>
          </div>

          {/* Total Customers */}
          <div className="metric-card bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-white bg-opacity-20 rounded-xl">
            ...
            <div>
              <p className="text-xs text-white opacity-90 mb-1">Total Customers</p>
              <p className="text-2xl font-bold text-white">{totalCustomers.toLocaleString()}</p>
            </div>
          </div>

          {/* Active Routes */}
          <div className="metric-card bg-gradient-to-br from-orange-500 to-orange-600 text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-white bg-opacity-20 rounded-xl">
            ...
            <div>
              <p className="text-xs text-white opacity-90 mb-1">Active Routes</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 slide-in-up">
            ...
            <div className="flex items-end justify-between h-64 gap-4">
              {weeklyData.map((day, index) => (
                <div key={index} className="flex flex-col items-center flex-1 group">
                  <div 
                    className="w-full relative rounded-t-md transition-all duration-300 hover:scale-110 chart-bar" 
                    style={{ 
                  ...
                  <span className="text-sm font-medium mt-3 text-gray-700">{day.day}</span>
          ...
          <div className="space-y-6">
            ...
            <div className="advanced-card p-6">
              ...
              <div>
                <p className="text-sm font-medium mb-1 text-gray-600">Net Profit Today</p>
            ...
            <div className="advanced-card p-6">
              ...
              <div>
                <p className="text-sm font-medium mb-1 text-gray-600">Total Entries</p>
                <p className="text-xl font-bold text-gray-900">{entries.length.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="advanced-card p-6">
              ...
              <div>
                <p className="text-sm font-medium mb-1 text-gray-600">Stock Movements</p>
                <p className="text-xl font-bold text-gray-900">{stockMovements.length.toLocaleString()}</p>
              </div>
            </div>
          </div>
        </div>
